...
DESCRIPTION = 'JupyterLab sample extension'
LONG_DESCRIPTION = """
...
class NPM(Command):
    ...
    targets = [
        pjoin(repo_root, 'samplelabextension', 'static', 'samplelabextension.bundle.js')
    ]
    ...
    def run(self):
        ...
        for t in self.targets:
            if not os.path.exists(t):
                ...
                if not has_npm:
                    msg += '\nnpm is required to build a development version of samplelabextension'
...
setup_args = dict(
    ...
    scripts         = [],
    packages        = ['samplelabextension'],
    description     = DESCRIPTION,
    long_description = LONG_DESCRIPTION,
    author          = 'Fumiaki Tokuhisa',
    author_email    = 'tokuhisa.f@gmail.com',
    url             = 'https://fumiaki.xyz/',
    license         = 'MIT',
